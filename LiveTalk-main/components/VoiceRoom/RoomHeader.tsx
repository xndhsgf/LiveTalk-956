...
const RoomHeader: React.FC<RoomHeaderProps> = ({ room, onLeave, onMinimize, onShowParticipants, isVisible = true }) => {
    ...
    <div className="flex justify-between items-center p-4 pt-12 bg-gradient-to-b from-black/80 to-transparent shrink-0 z-[1000] relative">
      ...
      <div className="flex items-center gap-2">
        <button 
          ...
          className="bg-black/40 hover:bg-black/60 backdrop-blur-md px-4 py-1.5 rounded-full flex items-center gap-2 border border-white/10 shadow-lg active:scale-95 transition-all"
        >
