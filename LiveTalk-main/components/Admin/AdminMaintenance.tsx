...
const AdminMaintenance: React.FC<AdminMaintenanceProps> = ({ currentUser }) => {
  ...
  // 1. تصفير الكاريزما لجميع المستخدمين (الكاس الداخلي/الخارجي للغرف)
  ...
  // 2. تصفير قائمة الملوك والداعمين (نقاط الثروة - الميزة المطلوبة)
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 text-right font-cairo" dir="rtl">
      ...
      {/* زر تصفير قائمة الملوك والداعمين - الميزة الجديدة المطلوبة */}
