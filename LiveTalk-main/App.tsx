        ...
        {activeTab === 'profile' && (
          <div className="flex flex-col bg-[#030816] min-h-full" dir="rtl">
            ...
            <div className="grid grid-cols-3 gap-2 px-4 mt-5">
              <button onClick={() => setShowWalletModal(true)} className="h-20 rounded-2xl bg-gradient-to-r from-blue-400 to-cyan-500 flex flex-col items-center justify-center shadow-lg active:scale-95 transition-transform"><Wallet size={20}/><span className="font-black text-[11px] mt-1">Wallet</span></button>
              <button onClick={() => setShowVIPModal(true)} className="h-20 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-800 flex flex-col items-center justify-center shadow-lg active:scale-95 transition-transform"><Crown size={20}/><span className="font-black text-[11px] mt-1">VIP</span></button>
              <button onClick={() => setShowBagModal(true)} className="h-20 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-700 flex flex-col items-center justify-center shadow-lg active:scale-95 transition-transform"><ShoppingBag size={20}/><span className="font-black text-[11px] mt-1">الحقيبة</span></button>
            </div>
            
            <div className="mx-4 mt-5 p-5 bg-white/5 rounded-[2rem] border border-white/5 grid grid-cols-3 gap-y-6">
